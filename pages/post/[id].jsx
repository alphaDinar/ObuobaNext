        ...
        <section className="main">
          {post && (
            <section className="news" data-aos="fade-up">
              ...
              <h3>{post.title}</h3>
              <div className="tag_box" data-tags="post.tags"></div>
              <div className="img_box">
                ...
                <p style={{ color: "black", minHeight: "auto" }}>
                  {post.content}
                </p>
                <nav>
                  <a>{iconFont("fa-brands fa-facebook-f", "#4867aa")}</a>
                  <a>{iconFont("fa-brands fa-whatsapp", "#39d855")}</a>
                  <a>{iconFont("fa-brands fa-twitter", "#1da1f2")}</a>
                  <a>{iconFont("fa-brands fa-google", "#e94235")}</a>
                  <a>{iconFont("fa-brands fa-linkedin", "#0077b5")}</a>
                </nav>
              </div>
            </section>
          )}
